...
namespace Bruderer.Core.Domain.Models.ModelProvider
{
    public interface IModelProvider
    {
        ...
        /// </exception>
        Task<bool> RegisterModelComponents(ModelUpdateOptions modelUpdateOptions, CancellationToken cancellationToken);
        ...
        /// </exception>
        Task<bool> PullVariableData(CancellationToken cancellationToken);

        /// <summary>
        /// Pulls model data from this model user by the passed Informations of <paramref name="variableIds"/>.
        /// </summary>
        /// <remarks>
        /// After a successful pull of the data from this model user the changed model variable values will be dispatched as <see cref="ModelVariablesValueChangeCommand"/> command. So the changed values can be catched via the regular flow in a corresponding event handler.
        /// </remarks>
        ...
        /// Thrown when the data coult not be pulled from this model user.
        /// </exception>
        Task<bool> PullVariableData(List<Guid> variableIds, CancellationToken cancellationToken);
