...
{
    public class ModelRPCInputArgument<T> : ModelRPCArgument
    {
        #region fields
        ...
        public static implicit operator T(ModelRPCInputArgument<T> var)
        {
            return var;
        }

        public static implicit operator string(ModelRPCInputArgument<T> var)
        {
            return var.ToString();
        }
