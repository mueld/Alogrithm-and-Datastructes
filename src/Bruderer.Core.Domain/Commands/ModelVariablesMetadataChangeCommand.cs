...
{
    public class ModelVariablesMetadataChangeCommand : ModelCommand
    {
        #region ctor

        public ModelVariablesMetadataChangeCommand(Guid modelId, IEnumerable<IModelVariableDEO> modelVariableDEOs, Guid callerId, string callerName)
            : base(modelId)
        {
        ...
        public ModelVariablesMetadataChangeCommand(Guid modelId, IEnumerable<IModelVariableDEO> modelVariableDEOs, Guid callerId, string callerName, IEnumerable<Guid> ignoredContextIds) 
